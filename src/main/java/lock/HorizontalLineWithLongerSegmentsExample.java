...
public class HorizontalLineWithLongerSegmentsExample extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // 增加横坐标点（例如：从 5 到 50，增加到 5 的倍数）
        int[] xCoords = {5, 10, 15, 20, 25, 30, 35, 40, 45, 50};
    ...
    public static void main(String[] args) {
        // 创建 JFrame
        JFrame frame = new JFrame("Horizontal Line with Longer Segments");
        HorizontalLineWithLongerSegmentsExample panel = new HorizontalLineWithLongerSegmentsExample();
